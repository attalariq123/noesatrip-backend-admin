                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('password.email') }}" method="post">
                                ...
                                <div class="form-group">
                                    <input type="email" name="email" value="{{ old('email') }}" class="form-control form-control-user @error('email') is-invalid @enderror" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="{{ __('Enter Email Address...') }}">
                                </div>
                                @error('email')
