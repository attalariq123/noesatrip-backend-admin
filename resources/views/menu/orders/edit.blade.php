                            ...
                            <div class="card-body col-lg-8">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="user_id"
                                        ...
                                        value="{{ $order->user->name }}" disabled required>
                                </div>
                                @error('user_id')
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" name="dest_id"
                                        class="form-control @error('dest_id') is-invalid @enderror"
                                        value="{{ $order->destination->name }}" disabled required>
                                </div>
                                @error('dest_id')
                                    <div class="form-group custom-control">
                                        <label class="">{{ $message }}</label>
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="number" name="ticket_qty"
                                        ...
                                        value="{{ $order->ticket_quantity }}" required>
                                </div>
                                @error('ticket_qty')
                                    <div class="form-group custom-control">
                                        <label class="">{{ $message }}</label>
